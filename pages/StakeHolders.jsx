...
function StakeHolders() {
    ...
    <form className='flex flex-col space-y-4 mb-10'>
                    ...
                    <button type="submit" onClick={addStakeHolder} disabled={waitForTransaction.isLoading || registering} className='bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md'>{waitForTransaction.isLoading ? "Transacting..... " : (registering ? "Check Wallet" : "Register")}</button>
                </form>
            </div>
            <div className='mx-20 my-10 bg-gradient-to-b from-purple-400 via-pink-400 to-red-400 px-4 py-2 rounded-lg shadow-md hover:shadow-lg overflow-hidden'>
    ...
    <form className='flex flex-col space-y-4 mb-10'>
                    ...
                    <button type='submit' onClick={readHolders} className='bg-purple-400 hover:bg-purple-400 text-white py-2 px-4 rounded-md'>Get Stakeholders</button>
                </form>
                {holders &&
