  ...
  return (
    <div>
      <main className='mx-20 my-10'>
        <div className='rounded-lg shadow-md hover:shadow-lg overflow-hidden bg-gradient-to-b from-purple-400 via-pink-400 to-red-400 text-black px-4 py-2 mb-20'>
          ...
          <form className='flex flex-col space-y-4 mb-10'>
            ...
            <button type="submit" onClick={whiteListAccounts} disabled={waitForTransaction.isLoading || registering} className='bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md'>{waitForTransaction.isLoading ? "Transacting..... " : (registering ? "Check Wallet" : "Register")}</button>
          </form>
        </div>
      </main>
      <div className='mx-20 my-10  bg-gradient-to-b from-purple-400 via-pink-400 to-red-400  px-4 py-2 rounded-lg shadow-md hover:shadow-lg overflow-hidden '>
        <h1 className='text-3xl font-bold mt-10 mb-5 text-black'>White Listed Accounts</h1>
        <form className='flex flex-col space-y-4 mb-10'>
          <div className='flex flex-col'>
            <label htmlFor='organisationAddress' className='mb-1 font-bold text-black'>Organisation Address:</label>
          ...
          <button type='submit' onClick={getWhiteListedAccounts} className='bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md'>Get WhiteListed Accounts</button>
        </form>
